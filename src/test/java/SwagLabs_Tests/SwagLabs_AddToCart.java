...
public class SwagLabs_AddToCart {
...
WebDriver driver;
	...
	public void Login() throws Throwable {
		...
		SwagLab_ProductsPage Addtocart = new SwagLab_ProductsPage(driver);
		Addtocart.Product_Backpack();
		Thread.sleep(3000);
		Addtocart.Product_BikeLight();
		Addtocart.Product_BoltTshirt();
		Addtocart.Product_Jacket();
		Addtocart.Product_Onesie();
		Addtocart.Product_RedTshirt();
		Addtocart.side_menu();
		Addtocart.Logout();
	}
